...
class Poubelles:
    def __init__(self):
        ...
        #jaune
        self.loc_pj = [830, 350]
        self.pjf = pygame.image.load('assets/poubelles/pjf.png')
        self.pjf = pygame.transform.scale(self.pjf, self.taille_poubelle)
        self.pjo = pygame.image.load('assets/poubelles/pjo.png')
        ...
        self.pvf = pygame.image.load('assets/poubelles/pvf.png')
        self.pvf = pygame.transform.scale(self.pvf, self.taille_poubelle)
        self.pvo = pygame.image.load('assets/poubelles/pvo.png')
        ...
        self.pbf = pygame.image.load('assets/poubelles/pbf.png')
        self.pbf = pygame.transform.scale(self.pbf, self.taille_poubelle)
        self.pbo = pygame.image.load('assets/poubelles/pbo.png')
        ...
        self.pnf = pygame.image.load('assets/poubelles/pnf.png')
        self.pnf = pygame.transform.scale(self.pnf, self.taille_poubelle)
        self.pno = pygame.image.load('assets/poubelles/pno.png')
